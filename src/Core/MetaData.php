...
class MetaData
{
    ...
    function __construct()
    {
        ...
        $this->_tags = $this->_keyword = [];
        $this->link = $_SERVER['SERVER_NAME'] ?? 'localhost';
        $this->tags = ['index', 'follow'];
    ...
    {
        $link_exist = $this->getLink();
        $type_exist = $this->getType();
    ...
    {
        $link_exist = $this->getLink(true);
        $cover_exist = $this->getCover(true);
        $lang_exist = $this->getLang(true);
        $canonical_exist = $this->getCanonical(true);
        $type_exist = $this->getType(true);
    ...
    protected function getTags(): string
    {
        ...
        return count($this->_tags) > 0 ? "<meta name=\"robots\" content=\"$tags\">" : '';
    }
